...
class RestaurantDetails extends Component {
  ...
  render() {
    ...
    const categoryItens = uniqueCategories.map( category => {
      const itensOfCategory = this.props.selectRestaurant.products.filter( item => {
        ...
        <Container>
          <Card>
            ...
            <Info>
              ...
              <OtherInfoContainer>
                <OtherInfo>{this.props.selectRestaurant.deliveryTime} - {this.props.selectRestaurant.deliveryTime + 10} min</OtherInfo>
                <OtherInfo>Frete R${this.props.selectRestaurant.shipping},00</OtherInfo>
              </OtherInfoContainer>
              <OtherInfoContainer>
...
const mapDispatchToProps = (dispatch) => ({
  ...
  getRestaurantDetails: () => dispatch(fetchRestaurantsDetails())
})
